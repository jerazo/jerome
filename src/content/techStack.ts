...
const primarySkillNames = new Set([
  ...
  'Google Analytics',
  'Mixpanel',
  'AI-assisted dev (Cursor, Claude, Codex, ChatGPT)',
  'OpenAI API & Gemini',
  'AI Integration',
  'Local LLM',
  'Prompt engineering',
...
export const techStack: SkillCategory[] = [
  ...
  },
  {
    label: 'AI tooling',
    items: [
      { name: 'AI-assisted dev (Cursor, Claude, Codex, ChatGPT)', experience: '2 yrs' },
      { name: 'OpenAI API & Gemini', experience: '2 yrs' },
      { name: 'AI Integration', experience: '2 yrs' },
      { name: 'Local LLM', experience: '~1 yr' },
      { name: 'Prompt engineering', experience: '2 yrs' },
      { name: 'RAG & AI agents', experience: '~1 yr' },
      { name: 'Workflow automation (n8n)', experience: '1 yr' },
      { name: 'MCP integrations', experience: '~1 yr' },
    ],
  },
  {
